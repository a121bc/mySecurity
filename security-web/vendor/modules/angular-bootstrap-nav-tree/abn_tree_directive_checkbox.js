    ...
    '$timeout', function($timeout) {
      return {
        ...
        link: function(scope, element, attrs) {
          let error, expand_all_parents, expand_level, for_all_ancestors, for_each_branch, get_parent, n, on_treeData_change, select_branch, selected_branch, tree;
          let label = scope.treeLabel || 'label';
          let children = scope.treeChildren || 'children';
          error = function(s) {
            console.log('ERROR:' + s);
            debugger;
            return void 0;
          ...
          on_treeData_change = function() {
            let add_branch_to_list, root_branch, _i, _len, _ref, _results;
            ...
            add_branch_to_list = function(level, branch, visible) {
              let child, child_visible, tree_icon, _i, _len, _ref, _results;
